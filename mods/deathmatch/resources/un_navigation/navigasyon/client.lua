...
Instance = {
	...
	find = function(self)
		...
		self.window = guiCreateWindow(0, 0, 510, 333, "UNTMTA | Navigasyon Sistemi", false)
		exports.un_global:centerWindow(self.window)
                ...
                addEventHandler('onClientGUIClick', ok,
                	function(b, s)
                                ...
                                if selectedRow ~= -1 then
                                       ...
                                       exports.un_navigation:findBestWay(Locations[selectedJob][2][1], Locations[selectedJob][2][2], Locations[selectedJob][2][3])
                                end
                	end
                )
