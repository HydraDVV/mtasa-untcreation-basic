		...
		function(qh)
			...
			if rows > 0 then
				for index, row in ipairs(res) do
					...
					exports.un_anticheat:changeProtectedElementDataEx( temporaryObject, "computer:clickable", true, true )
				end
			end
		end,
...
addEventHandler("computers:on", root,
	function()
		exports.un_global:sendLocalMeAction(client, "bilgisayarı açar.")
	end
)