...
function options_showmenu()
	...
	wOptions = guiCreateStaticImage(left, top, windowWidth, windowHeight, ":un_resources/window_body.png", false)
	...
	if getResourceFromName("un_admins") and exports['un_admins']:canPlayerAccessStaffManager(localPlayer) then
	...
	if getResourceFromName("un_factions") and exports.un_factions:canAccessFactionManager( localPlayer ) then
	...
	if getResourceFromName("un_interiors") and getResourceFromName("un_interior_manager") and exports.un_integration:isPlayerAdmin( localPlayer ) then
	...
	if getResourceFromName("un_vehicle") and getResourceFromName("un_vehicle_manager") and exports.un_vehicle_manager:canAccessVehicleManager( localPlayer ) then
	...
	if getResourceFromName('un_vehicle') and getResourceFromName("un_vehicle_manager") then
	...
	exports.un_global:centerWindow(wOptions)
end
