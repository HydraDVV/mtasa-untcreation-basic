...
GUIEditor = {
	...
	gui["_root"] = guiCreateWindow(0, 0, 349, 164, "Araç Satın Alma Ekranı - UNT", false)
	guiWindowSetSizable(gui["_root"], false)
	exports.un_global:centerWindow(gui["_root"])
	...
	if exports.un_global:hasItem(localPlayer, 263, 1) and carPrice < 25000 then
...
function carshop_buyCar_click()
	if exports.un_global:hasSpaceForItem(getLocalPlayer(), 3, 1) then
