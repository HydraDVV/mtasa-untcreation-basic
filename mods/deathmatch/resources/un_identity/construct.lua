idsystem = {
	...
	_join = function(self)
		for i = 1, 5000 do
			...
			exports.un_anticheat:changeProtectedElementDataEx(source, "playerid", slot)
			exports.un_pool:allocateElement(source, slot)
	...
	_define = function(self) self.players = getElementsByType("player")
		...
		for key, value in ipairs(self.players) do
			...
			exports.un_anticheat:changeProtectedElementDataEx(value, "playerid", key)
			exports.un_pool:allocateElement(value, key)
