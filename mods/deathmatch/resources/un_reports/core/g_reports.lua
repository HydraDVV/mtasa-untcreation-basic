...
adminTeams = exports.un_integration:getAdminStaffNumbers()
auxiliaryTeams = exports.un_integration:getAuxiliaryStaffNumbers()
SUPPORTER = exports.un_integration:getSupporterNumber()
	...
	for k,v in ipairs(staff) do
		if v == 39 or v == 43 then
			...
			for key, player in ipairs(players) do
				if exports.un_integration:isPlayerVCTMember(player) or exports.un_integration:isPlayerVehicleConsultant(player) then
					vcount = vcount + 1
					save = player
				end
			end
...
function showExternalReportBox(thePlayer)
	...
	return (exports.un_integration:isPlayerTrialAdmin(thePlayer) or exports.un_integration:isPlayerSupporter(thePlayer)) and (getElementData(thePlayer, "report_panel_mod") == "2" or getElementData(thePlayer, "report_panel_mod") == "3")
end

function showTopRightReportBox(thePlayer)
	if not thePlayer then return false end
	return (exports.un_integration:isPlayerTrialAdmin(thePlayer) or exports.un_integration:isPlayerSupporter(thePlayer)) and (getElementData(thePlayer, "report_panel_mod") == "1" or getElementData(thePlayer, "report_panel_mod") == "3")
end
