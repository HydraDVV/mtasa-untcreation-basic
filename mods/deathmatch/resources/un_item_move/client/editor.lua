...
local function canEditObject( object )
  return exports.un_integration:isStaffOnDuty(localPlayer) or exports.un_integration:isPlayerScripter(localPlayer)
end
...
addEventHandler('item:move', root,
  function(object)
    ...
    if editing and object then
      ...
      if exports.un_integration:isPlayerTrialAdmin(localPlayer) then
