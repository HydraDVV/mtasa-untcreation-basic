...
function deleteLift(thePlayer, commandName, id)
	if (exports.un_integration:isPlayerTrialAdmin(thePlayer) or tostring(getElementData(thePlayer, "account:username")) == "bekiroj") then
...
function liftOutputMe(text)
	if text then
		exports.un_global:sendLocalMeAction(client, tostring(text))
	end	
end
