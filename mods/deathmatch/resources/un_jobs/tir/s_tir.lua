...
function dorseOlustur()
	local vehShopData = exports["un_vehicle_manager"]:getInfoFromVehShopID(1012)
	local veh = createVehicle(435, 2267.8115234375, -2401.49609375, 14.040822982788, 0, 0, 312.48352050781)
	exports.un_anticheat:changeProtectedElementDataEx(veh, "dbid", -1, true)
	exports.un_anticheat:changeProtectedElementDataEx(veh, "fuel", exports["un_vehicle_fuel"]:getMaxFuel(veh), false)
	exports.un_anticheat:changeProtectedElementDataEx(veh, "plate", "TIR", true)
	...
	exports.un_anticheat:changeProtectedElementDataEx(veh, "job", 6, false)
	exports.un_anticheat:changeProtectedElementDataEx(veh, "handbrake", 0, true)
	exports.un_anticheat:changeProtectedElementDataEx(veh, "tirMeslek", 1, true)
	
	exports.un_anticheat:changeProtectedElementDataEx(veh, "brand", vehShopData.vehbrand, true)
	exports.un_anticheat:changeProtectedElementDataEx(veh, "maximemodel", vehShopData.vehmodel, true)
