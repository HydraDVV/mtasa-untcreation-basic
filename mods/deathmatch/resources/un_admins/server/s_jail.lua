...
function jailPlayer(thePlayer, commandName, who, minutes, ...)
	if (exports.un_integration:isPlayerTrialAdmin(thePlayer)) then
		...
		if not (who) or not (minutes) or not (...) or (minutes<1) then
			...
			local targetPlayer, targetPlayerName = exports.un_global:findPlayerByPartialNick(thePlayer, who)
			...
			if (targetPlayer) then
				...
				if (isPedInVehicle(targetPlayer)) then
					exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "realinvehicle", 0, false)
				...
				if (minutes>=999) then
					...
					minutes = "Sınırsız"
					exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "jailtimer", true, false)
				else
					...
					exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "jailserved", 0, false)
					exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "jailtimer", theTimer, false)
				end
				exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "adminjailed", true, false)
				exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "jailreason", reason, false)
				exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "jailtime", minutes, false)
				exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "jailadmin", getPlayerName(thePlayer), false)
				
				local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")

				addAdminHistory(targetPlayer, thePlayer, reason, 0 , (tonumber(minutes) and ( minutes == 999 and 0 or minutes ) or 0))
				
				local adminTitle = exports.un_global:getAdminTitle1(thePlayer)
				...
				if commandName == "sjail" then
					if tonumber(minutes) then
						exports.un_global:sendMessageToAdmins("[Sessiz Ceza]: " .. adminTitle .. " İsimli Admin " .. targetPlayerName .. " İsimli oyuncuyu " .. minutes .. " dakika cezalandırdı.")
						exports.un_global:sendMessageToAdmins("[Sessiz Ceza]: Sebep: " .. reason)
						exports.un_logs:dbLog(thePlayer, 4, targetPlayer,commandName.." for "..minutes.." mins, reason: "..reason)
					else
						exports.un_global:sendMessageToAdmins("[[Sessiz Ceza]: " .. adminTitle .. " İsimli Admin " .. targetPlayerName .. " İsimli oyuncuyu "..minutes.." dakika cezalandırdı.")
						exports.un_global:sendMessageToAdmins("[Sessiz Ceza]: Sebep: " .. reason)
						exports.un_logs:dbLog(thePlayer, 4, targetPlayer,commandName.." "..minutes..", reason: "..reason)
					end
				else
					if tonumber(minutes) then
	...
	if (exports.un_integration:isPlayerTrialAdmin(thePlayer)) then
		...
		if not (who) or not (minutes) or not (...) or (minutes<1) then
			...
			if commandName == "sojail" then
				exports.un_global:sendMessageToAdmins("[Sessiz-Ceza]: " .. adminTitle .. " İsimli Admin " .. accountUsername .. " İsimli oyuncuyu " .. minutes .. " dakika cezalandırdı.")
				exports.un_global:sendMessageToAdmins("[Sessiz-Ceza]: Sebep: " .. reason)
			else
			...
			exports.un_logs:dbLog(thePlayer, 4, thePlayer,commandName.." "..accountUsername.." for "..minutes.." mins, reason: "..reason)
		end
	end
end
...
function timerUnjailPlayer(jailedPlayer)
	if(isElement(jailedPlayer)) then
		...
		if (timeServed) then
			exports.un_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailserved", timeServed+1, false)
			local timeLeft = timeLeft - 1
			exports.un_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailtime", timeLeft, false)
			...
			if (timeLeft<=0) and not (getElementData(jailedPlayer, "pd.jailtime")) then
				...
				exports.un_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailtimer", false, false)
				exports.un_anticheat:changeProtectedElementDataEx(jailedPlayer, "adminjailed", false, false)
				exports.un_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailreason", false, false)
				exports.un_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailtime", false, false)
				exports.un_anticheat:changeProtectedElementDataEx(jailedPlayer, "jailadmin", false, false)
				...
				exports.un_global:sendMessageToAdmins("[JAIL]: " .. getPlayerName(jailedPlayer):gsub("_", " ") .. " has served " .. genderm .. " jail time.")
		...
		if not (who) then
			...
			if (targetPlayer) then
				...
				if not (jailed) then
					...
					exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "jailtimer", false, false)
					exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "adminjailed", false, false)
					exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "jailreason", false, false)
					exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "jailtime", false, false)
					exports.un_anticheat:changeProtectedElementDataEx(targetPlayer, "jailadmin", false, false)
					...
					exports.un_global:sendMessageToAdmins("[ADMIN-CEZA]: " .. targetPlayerName .. " İsimli oyuncunun "..adminTitle.." tarafından cezası sonlandırıldı.")
					exports.un_logs:dbLog(thePlayer, 4, targetPlayerName,commandName)
				end
			end
		end
	end
