...
function getAdminTitle(thePlayer)
	return exports.un_global:getPlayerAdminTitle(thePlayer)
end
...
local function updateGUI()
	if show then
		...
		local adminLevel = exports.un_global:getPlayerAdminLevel(localPlayer) or 0
		if exports.un_integration:isPlayerSupporter(localPlayer) or exports.un_integration:isPlayerTrialAdmin(localPlayer) then
...
addCommandHandler("staffoverlay", function()
 if exports.un_integration:isPlayerSupporter(localPlayer) or exports.un_integration:isPlayerTrialAdmin(localPlayer) then
	if (show == true) then
		show = false
		exports.un_notification:create("Yetkili arayüzünü in-aktif hale getirdin. Raporları farklı bir şekilde okumak istiyorsan /rapordurum ac yazabilirsin.", "info")
	else
		show = true
		exports.un_notification:create("Yetkili arayüzünü aktif hale getirdin.", "info")
	end
 end
end)
...
function drawText ( )
	if show and exports.un_global:isStaffOnDuty(localPlayer) then
