...
function frames_showTexGUI ( )
	...
	if interiorID >= 1 or (exports.un_integration:isPlayerSeniorAdmin(localPlayer) and exports.un_global:isAdminOnDuty(localPlayer)) or exports.un_integration:isPlayerScripter(localPlayer) then
		if exports.un_global:hasItem ( localPlayer, 4, interiorID ) or exports.un_global:hasItem ( localPlayer, 5, interiorID ) or (exports.un_integration:isPlayerAdmin(localPlayer) and exports.un_global:isAdminOnDuty(localPlayer)) or (interiorID==0) then
			if not gui.window then
				...
				if(not exports.un_global:hasItem(localPlayer, 4, interiorID) and not exports.un_global:hasItem(localPlayer, 5, interiorID)) then
