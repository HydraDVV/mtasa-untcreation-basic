function loadFonts()
    fonts = {
        ...
        [3] = DxFont(":un_fonts/files/RobotoL.ttf", 12),
        [4] = DxFont(":un_fonts/files/RobotoL.ttf", 10),
        [5] = DxFont(":un_fonts/files/RobotoL.ttf", 9),
        [6] = DxFont(":un_fonts/files/RobotoL.ttf", 6),
        [7] = GuiFont(":un_fonts/files/RobotoL.ttf", 10),
        [8] = DxFont(":un_fonts/files/RobotoL.ttf", 8.4),
        [9] = DxFont(":un_fonts/files/FontAwesome5.ttf", 10),
        [10] = DxFont(":un_fonts/files/FontAwesome.ttf", 7),
        [11] = DxFont(":un_fonts/files/Roboto-Regular.ttf", 10),
        [12] = DxFont(":un_fonts/files/RobotoB.ttf", 10),
        [13] = DxFont(":un_fonts/files/FontAwesome.ttf", 10),
    }
end
