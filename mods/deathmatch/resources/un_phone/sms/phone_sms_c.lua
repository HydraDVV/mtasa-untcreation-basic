...
--	end
	...
	if date2 then
		local date = guiCreateLabel(xoffset+margin, xoffset+margin*2+newContentH, boxW-margin*2, boxH-margin*2, exports.un_datetime:formatTimeInterval( date ), false, body)
