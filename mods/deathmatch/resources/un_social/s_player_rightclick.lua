...
function restrainPlayer(player, restrainedObj)
	...
	exports.un_global:takeItem(source, restrainedObj)

	if (restrainedObj==45) then -- If handcuffs.. give the key
		exports['un_items']:deleteAll(47, dbid)
		exports.un_global:giveItem(source, 47, dbid)
	end
...
function unrestrainPlayer(player, restrainedObj)
	...
	exports.un_global:giveItem(source, restrainedObj, 1)
...
function blindfoldPlayer(player)
	...
	exports.un_global:takeItem(source, 66) -- take their blindfold
...
function removeblindfoldPlayer(player)
	...
	exports.un_global:giveItem(source, 66, 1) -- give the remove the blindfold
...
function stabilizePlayer(player)
	local found, slot, itemValue = exports.un_global:hasItem(source, 70)
	if found then
		if itemValue > 1 then
			exports['un_items']:updateItemValue(source, slot, itemValue - 1)
		else
			exports.un_global:takeItem(source, 70, itemValue)
		end
