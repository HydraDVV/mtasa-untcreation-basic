...
function sendStatus( thePlayer, commandName, ... )
	...
	exports.un_notification:create(thePlayer,"Başarılı bir şekilde /status durumunu etkinleştirdiniz.", "success")
...
function sendToNearByClientsStatus(root, message)
	...
	for k, v in pairs(exports.un_pool:getPoolElementsByType("player")) do
