function editVehicle(thePlayer, commandName)
	if exports.un_integration:isPlayerVehicleConsultant(thePlayer) or exports.un_integration:isPlayerSeniorAdmin(thePlayer) or exports.un_integration:isPlayerVCTMember(thePlayer) then
		...
		exports.un_logs:dbLog(thePlayer, 4, { theVehicle, thePlayer }, commandName)
		return true
	end
end
...
function createUniqueVehicle(data, existed)
	...
	local vehicle = exports.un_pool:getElement("vehicle", tonumber(data.id))
	...
	if not existed then
		...
		exports.un_logs:dbLog(client, 6, { client }, " Created unique vehicle #"..data.id..".")
		exports.un_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has created new unique vehicle #"..data.id..".")
		exports["un_vehicle"]:reloadVehicle(tonumber(data.id))
		...
		exports.un_logs:dbLog(client, 6, { client }, " Updated unique vehicle #"..data.id..".")
		exports.un_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has updated unique vehicle #"..data.id..".")
		exports["un_vehicle"]:reloadVehicle(tonumber(data.id))
		return true
	end
end
...
function resetUniqueVehicle(vehID)
	...
	exports.un_logs:dbLog(client, 6, { client }, " Removed unique vehicle #"..vehID..".")
	exports.un_global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has removed unique vehicle #"..vehID..".")
	exports["un_vehicle"]:reloadVehicle(tonumber(vehID))

	local vehicle = exports.un_pool:getElement("vehicle", tonumber(vehID))
...
function openUniqueHandling(vehdbid, existed)
	if exports.un_integration:isPlayerVehicleConsultant(client) or exports.un_integration:isPlayerSeniorAdmin(client) then
