function startRappel(x, y, z, gz)
	...
	exports.un_anticheat:changeProtectedElementDataEx(source, "realinvehicle", 0, false)
	removePedFromVehicle(source)
	attachElements(source, invisible)
	moveObject(invisible, 2000, x, y, gz, 0, 0, 0)
	exports.un_pool:allocateElement(invisible)
	setTimer(stopRappel, 2000, 1, invisible, source, slot)
	exports.un_global:applyAnimation(source, "PARACHUTE", "PARA_float", true, 1.0, false, false)
	for key, value in ipairs(exports.un_global:getNearbyElements(invisible, "player", 100)) do
