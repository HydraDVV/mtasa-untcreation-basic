...
function switchModex()
	if isPD() and (getPedWeapon(localPlayer)==25) and (getPedTotalAmmo(localPlayer)>0) then
		...
		elseif mode == 1 then
			outputChatBox(exports.un_pool:getServerSyntax(false, "s").."Silah modu başarıyla Beanbag mod olarak ayarlandı.", 0, 255, 0, true)
