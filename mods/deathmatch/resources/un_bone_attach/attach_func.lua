...
function attach(element,ped,bone,x,y,z,rx,ry,rz)
...
function getDetails(element)
	if not isAttached(element) then return false end
...
function setPositionOffset(element,x,y,z)
	local ped,bone,ox,oy,oz,rx,ry,rz = getDetails(element)
	if not ped then return false end
	return attach(element,ped,bone,x,y,z,rx,ry,rz)
end

function setRotationOffset(element,rx,ry,rz)
	local ped,bone,x,y,z,ox,oy,oz = getDetails(element)
	if not ped then return false end
	return attach(element,ped,bone,x,y,z,rx,ry,rz)
end
