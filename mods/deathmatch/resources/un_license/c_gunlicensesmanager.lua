...
function issuelicenseGUI()
	...
	addEventHandler("onClientGUIClick", issue.button[1], function ()
		...
		if licensetype == "Tier 2" then
			if exports.un_factions:isPlayerFactionLeader(getLocalPlayer(), 1) or exports.un_factions:isPlayerFactionLeader(getLocalPlayer(), 50) or exports.un_integration:isPlayerSeniorAdmin(getLocalPlayer()) then
			else
