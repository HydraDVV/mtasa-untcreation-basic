...
Radar.font = {
    [1] = exports.un_fonts:getFont("RobotoB", 11),
    [2] = exports.un_fonts:getFont("RobotoB", 11),
} 
...
Radar.render = function()
    if active then
        ...
        local cash = ""..getElementData(localPlayer, "money").."₺"
        mapX = (pX) / 6000
        mapY = (pY) / -6000
        --if getElementInterior(localPlayer) == 0 then
            ...
            dxDrawImage(RADAR_POS.x-7/zoom, RADAR_POS.y-7/zoom, RADAR_POS.w+16/zoom, RADAR_POS.h+16/zoom, Radar.shadow, 0, 0, 0, tocolor(255, 255, 255, 255))
        ...
        --end
        dxDrawText('Istanbul', 265/zoom, sH-165/zoom, 325/zoom, sH-145/zoom, tocolor(144, 144, 144), 1/zoom, Radar.font[2])
        dxDrawText(getZoneNameEx(x, y, z), 265/zoom, sH-147/zoom, 325/zoom, sH-127/zoom, tocolor(222, 222, 222), 1/zoom, Radar.font[1])
        dxDrawText(cash, 265/zoom, sH-128/zoom, 325/zoom, sH-145/zoom, tocolor(226, 192, 74), 1/zoom, Radar.font[2])
    end
end
