...
function draw()
	...
	if isPedInVehicle ( localPlayer ) then
		...
		if radioID and radioID >= 0 and streams[radioID] and getVehicleType(vehicle) ~= 'BMX' and getVehicleType(vehicle) ~= 'Bike' and getVehicleType(vehicle) ~= 'Quad' then
			...
			dxDrawShadowText(text, sx/2-250/2+1, 20, 250+(sx/2-250/2)+1, 30, tocolor(200, 200, 200, 200), 1, font, "center", "top")
	...
	if mp3Station and mp3Station ~= nil then
		...
		dxDrawImage ( left-10, top - 2, 50, 50, ":un_hud/images/radio.png" ,0, 0, 0, tocolor(255,255,255), true )
...
function showMP3GUI()
	...
	mp3Window = guiCreateStaticImage(mp3_x, mp3_y, mp3_w, mp3_h, ":un_resources/window_body.png", false)
