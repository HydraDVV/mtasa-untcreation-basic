function mixDrugs(drug1, drug2, drug1name, drug2name)
	...
	if (drugName == nil or drugID == nil) then
		outputChatBox("Error #1000 - Report on https:/www.UNTroleplay.com/ucp", source, 255, 0, 0)
		return
	end
	
	exports.un_global:takeItem(source, drug1)
	exports.un_global:takeItem(source, drug2)
	local given = exports.un_global:giveItem(source, drugID, 1)
	
	if (given) then
		outputChatBox("You mixed '" .. drug1name .. "' and '" .. drug2name .. "' to form '" .. drugName .. "'", source)
		exports.un_global:sendLocalMeAction(source, "mixes some chemicals together.")
	else
		outputChatBox("You do not have enough space to mix these chemicals.", source, 255, 0, 0)
		exports.un_global:giveItem(source, drug1, 1)
		exports.un_global:giveItem(source, drug2, 1)
	end
end
